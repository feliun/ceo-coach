...
chk "fallback missing mtrx"  commands/review.md "Detailed metrics missing"
chk "fallback never zero"    commands/review.md "Never render a missing metric as \`0\`"
chk "fallback retweets"      commands/review.md "never carry organic metrics"
